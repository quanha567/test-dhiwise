...
import C12SignUpActivePassword from "components/C12SignUpActivePassword";

import "react-circular-progressbar/dist/styles.css";

const SignUpActivePage: React.FC = () => {
  return (
    <>
      <div className="bg-white-A700 flex sm:flex-col md:flex-col flex-row font-inter sm:gap-5 md:gap-5 items-center mx-auto w-full">
        ...
        <div className="flex flex-col items-start justify-end p-[105px] md:px-5 w-[51%] md:w-full">
          <Text
            className="md:ml-[0] ml-[58px] mt-14 text-2xl md:text-[22px] text-gray-900 sm:text-xl tracking-[0.20px]"
          ...
          <div className="flex flex-col gap-4 items-start justify-start md:ml-[0] ml-[58px] mt-[29px] w-[404px] sm:w-full">
            <Input
              name="username"
              placeholder="Angela laufeau"
              className="!placeholder:text-gray-900 !text-gray-900 font-semibold md:h-auto p-0 sm:h-auto text-base text-left tracking-[0.20px] w-full"
            ...
            <Input
              name="email"
              placeholder="Angela.laufeau@mail.com"
              className="!placeholder:text-gray-900 !text-gray-900 font-semibold md:h-auto p-0 sm:h-auto text-base text-left tracking-[0.20px] w-full"
              wrapClassName="flex w-full"
              type="email"
              prefix={
            ...
            ></Input>
            <C12SignUpActivePassword className="flex flex-col gap-3 items-start justify-start w-full" />
          </div>
...
export default SignUpActivePage;
